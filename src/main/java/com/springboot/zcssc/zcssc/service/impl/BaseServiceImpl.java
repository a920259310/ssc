...
import com.springboot.zcssc.zcssc.mapper.AccountSingMapper;
...
public class BaseServiceImpl<T> implements BaseService<T> {
    ...
    @Autowired
    protected AccountSingMapper accountSingMapper;
    ...
    @Override
    public int updateNotNullBatch(List<T> entitys) {
        for(T t : entitys){
            this.updateNotNull(t);
        }
        return 0;
    }
